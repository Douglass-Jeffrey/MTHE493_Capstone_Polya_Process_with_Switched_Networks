...
def run_growth_batches(num_batches, batch_size):
...
initial_nodes = 1024
num_batches = cp_module.array([1024, 512, 64], dtype=cp_module.int32)
batch_sizes = cp_module.array([64, 2048, 322144], dtype=cp_module.int32)
polya_steps = 1000

"""
initial_nodes = 64
num_batches = cp_module.array([256, 512, 2048], dtype=cp_module.int32)
batch_sizes = cp_module.array([1, 4, 16], dtype=cp_module.int32)
polya_steps = 100
"""
"""
initial_nodes = 32
num_batches = cp_module.array([128, 64, 32, 16, 8], dtype=cp_module.int32)
batch_sizes = cp_module.array([4, 16, 64, 256, 1024], dtype=cp_module.int32)
polya_steps = 1
"""
