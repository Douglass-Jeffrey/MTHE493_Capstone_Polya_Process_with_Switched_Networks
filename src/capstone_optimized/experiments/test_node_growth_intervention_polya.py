...
batch_sizes = cp_module.array([   8,  128, 2048, 65536/16], dtype=cp_module.int32)
...
intervener_urn = cp_module.array([64,0], dtype=cp_module.int32)
polya_steps = 1024
...
polya = Polya_Process(graph, memory_enabled=True, memory_decay_time=128)
